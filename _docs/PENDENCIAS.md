...
**Caminho decidido em 2026-08-29: nascer desligada.** Não entrou nesta versão porque o `.deb` 2.0.16
do Linux foi empacotado com `captureSystemAudio: true` e não seria reconstruído — mudar o default só
do lado do Windows recriaria a divergência de código entre os dois sistemas que a republicação do
`.exe` acabou de fechar. Vai na próxima versão, empacotada nos dois.

Os outros caminhos, deixados de lado por ora:
