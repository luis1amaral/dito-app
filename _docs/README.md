# `_docs/` — os porquês que não cabem no código

Comentário neste projeto tem no máximo uma linha. Quando a razão de uma decisão não cabe nela, ela
vem para cá e o código deixa um ponteiro.
...
O histórico do produto está no `CHANGELOG.md`, na raiz.
